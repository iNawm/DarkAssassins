...
public class Class305 implements Interface27 {
	...
	boolean method3746(String string, Class<Class294> var_class, int i) {
		try {
			...
			do {
				if (file != null) {
					...
					try {
						...
						Class<Runtime> var_class_8_ = java.lang.Runtime.class;
						Class<AccessibleObject> var_class_9_ = java.lang.reflect.AccessibleObject.class;
