...
public class Class445 {
	...
	static void method5895(GraphicsToolkit class_ra, byte i) {
		try {
			...
			class_ra.B(0, 0, -2110394505 * Class462.anInt5683, 350, Class8.anInt98 * 256666041 << 24 | Settings.CONSOLE_COLOUR, 1);
			}
			...
			if (Class8.anInt102 * -2035787443 > 0) {
				...
				class_ra.B(Class462.anInt5683 * -2110394505 - 16, i_5_, 12, i_4_, Class8.anInt98 * 256666041 << 24 
