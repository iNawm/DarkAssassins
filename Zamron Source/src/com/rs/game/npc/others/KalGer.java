 ...
 *
 * @author `Leon on r-s
 * Supplier for fly anim: Jericho pr0dx
 *
 */
...
public class KalGer extends NPC {
        ...
        private void Flytele(String string) {
                ...
                if(string.equalsIgnoreCase("south")) {
                        ...
                        //setCantInteract(true);
                        System.out.println("disabled interaction");
                        ...
                        WorldTasksManager.schedule(new WorldTask() {
                                ...
                                public void run() {
                                        ...
                                        System.out.println("enabled interaction");
                                        stop();
                        ...
                        /*setCantInteract(true);
                        setNextAnimation(new Animation(14995);
                        setNextForceMovement(new ForceMovement(new WorldTile(196, 5521, 0), 6, 2));
                        //setNextAnimation(new Animation(-1));
                        WorldTasksManager.schedule(new WorldTask() {
                                @Override
                                public void run() {
                ...
                WorldTasksManager.schedule(new WorldTask() {
                        ...
                        public void run() {
                                ...
                                for(Player target : playersOn) {
                                        if(target.withinDistance(KalGer.this, 15)) {
                        ...
                        WorldTasksManager.schedule(new WorldTask() {
                                public void run() {
                                        ...
                                        for(Player inarea : playersOn) {
                                                        ...
                                                        inarea.sm("You recieved 5M in your bank as a reward for your braveness!");
                                                        inarea.sm("The ladder at the south-east corner of this room gets you out of here!");
