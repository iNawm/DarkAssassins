...
public class KalGerCombat extends CombatScript {
        ...
        public int attack(final NPC npc, Entity target) {
                ...
                switch (attackStyle) {
                case 0:
                        npc.setNextAnimation(new Animation(KalGer.Type.BARE_HANDED.getAnim()));
                        delayHit(npc, 1, target, getMeleeHit(npc, meleedamage));
                        break;
                case 1:
                        npc.setNextAnimation(new Animation(KalGer.Type.SWORDED.getAnim()));
                        delayHit(npc, 1, target, getMeleeHit(npc, meleedamage));
                        if (Utils.getRandom(14) == 0)
                                target.getPoison().makePoisoned(75);
                        break;
                case 2:
                        npc.setNextAnimation(new Animation(KalGer.Type.STAFFED.getAnim()));
                        ...
                        break;
                case 3:
                        npc.setNextAnimation(new Animation(KalGer.Type.TWO_HANDED.getAnim()));
                        ...
                        break;
                case 4:
                        npc.setNextAnimation(new Animation(KalGer.Type.BOWED.getAnim()));
                        ...
                        break;
                case 5:
                        npc.setNextAnimation(new Animation(KalGer.Type.MAULED.getAnim()));
                        delayHit(npc, 1, target, getMeleeHit(npc, meleedamage));
                        if (Utils.getRandom(14) == 0)
                                target.getPoison().makePoisoned(75);
                        break;
