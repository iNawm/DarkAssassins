...
public class CommendationExchange {//1875 TODO
	...
	if (componentId == 68) {
		...
		return;
	    player.getInventory().addItem(Herbs.values()[Utils.random(5)].getHerbId() + 1, Utils.random(4));
	    player.getInventory().addItem(Herbs.values()[Herbs.values().length - 1].getHerbId() + 1, Utils.random(2));
		...
		return;
	    player.getInventory().addItem(SEEDS[0][Utils.random(SEEDS[0].length)], Utils.random(5));
	    player.getInventory().addItem(SEEDS[0][Utils.random(SEEDS[0].length)], Utils.random(3));
	    player.getInventory().addItem(SEEDS[1][Utils.random(SEEDS[1].length)], Utils.random(2));
