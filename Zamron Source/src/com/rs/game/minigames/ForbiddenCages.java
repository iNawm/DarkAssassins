...
import com.rs.utils.TeleportManager;
import com.rs.utils.Utils;

public class ForbiddenCages {
	

	protected static WorldTile cage = new WorldTile(2472, 9678, 0);
	...
	public static void leaveCage(Player player, boolean logout) {
		...
		if (!logout)
			player.setNextWorldTile(TeleportManager.getLocation("cagelobby"));
		else
