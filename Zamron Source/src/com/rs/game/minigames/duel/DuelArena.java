...
public class DuelArena extends Controler {
    ...
    public void endDuel(final Player victor, final Player loser, boolean isDraw) {
      String[] drawMessages = { "The battle has ended in a draw!", "You drew!", "You and your opponent drew the battle!",
        		"The battle has finished; the outcome is a draw!", "You and your opponent drew!"};      
      String[] winMessages = { "You easily defeat "+loser.getDisplayName()+".", "You, sir laid "+loser.getDisplayName()+" to rest.", "You take the spoils from "+loser.getDisplayName()+".",
    		  "You defeated "+loser.getDisplayName()+"!", "Congratulations, you enlighten yourself with "+loser.getDisplayName()+"'s items!", "You take "+loser.getDisplayName()+"'s life.. and the spoils!"};
      String[] loseMessages = { "You lose the duel.", "You lost the duel to "+victor.getDisplayName()+".", "You have been defeated by "+victor.getDisplayName()+"." };
	...
	loser.getPackets().sendGameMessage(isDraw ? drawMessages[Utils.random(drawMessages.length)] : loseMessages[Utils.random(loseMessages.length)]);
	victor.getPackets().sendGameMessage(isDraw ? drawMessages[Utils.random(drawMessages.length)] : winMessages[Utils.random(winMessages.length)]);
