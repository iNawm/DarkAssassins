...
import com.rs.game.player.content.Donator;
import com.rs.game.player.content.PlayerLook;
import com.rs.game.player.content.PlayerSupport;
import com.rs.game.player.content.SerenityOptions;
...
public class Noticeboard extends Dialogue {
	...
	public void start() {
		...
		sendOptionsDialogue("What you would like to do?", "View my character settings",
				"Zamron Options", "Open Donator Panel", "Loyalty Programme", "Next page");
	...
	public void run(int interfaceId, int componentId) {
		if (stage == 1) {
			if (componentId == OPTION_1) {
				...
				sendOptionsDialogue("Zamron Game Options", "Login screen options.",
