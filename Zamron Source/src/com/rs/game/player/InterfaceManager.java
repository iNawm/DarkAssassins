...
player.getInterfaceManager().sendInterface(813);
	player.getPackets().sendItemOnIComponent(813, 33, 1050, 1);
        player.getPackets().sendIComponentText(813, 80,  "Zamron"); //Title
	...
	public void sendCompCape() {
		...
		if (player.penguins >= 15) {
		player.getPackets().sendIComponentText(275, 14, "<str><col=330099>I must have spotted many Penguins from Hide and Seek. ("+player.penguins+"/15)</col></str>");
		} else {
		player.getPackets().sendIComponentText(275, 14, "<col=330099>I must have spotted many Penguins from Hide and Seek. ("+player.penguins+"/15)</col>");
		}
	...
	public void sendSkype() {
		...
		player.getPackets().sendIComponentText(72, 32, "Zamron Group");
		player.getPackets().sendIComponentText(72, 35, "Owner: Leighton");
		player.getPackets().sendIComponentText(72, 40, "Co-Owner: NuOne");
	...
	player.getPackets().sendIComponentText(220, 1, "<col=24246B>The Official Zamron Barcrawl!"); //Title
	...
	public void sendHelpBook() {
		...
		player.getInterfaceManager().sendInterface(275);
		player.getPackets().sendIComponentText(275, 1, "<col=0099FF>Zamron Help");
		player.getPackets().sendIComponentText(275, 10, "");
		...
		player.getPackets().sendIComponentText(275, 25, "<col=990099>You can ask for help in Zamron's Friendchat, Leighton.");
		player.getPackets().sendIComponentText(275, 26, "");
		player.getPackets().sendIComponentText(275, 27, "Need more help? Check out our forums at www.Zamron.net");
	...
	public void sendPlayerCustom() {
        ...
        player.getPackets().sendIComponentText(506, 0, "<col=00FF00><shad=000000>~ Zamron Project ~");
	...
	public void gazeOrbOfOculus() {
		...
		public void sendStatistics() {
		 player.getInterfaceManager().sendInterface(275);
         player.getPackets().sendIComponentText(275, 1, "<img=8><col=00FF00><shad=000000>Player Statistics<img=8>");
