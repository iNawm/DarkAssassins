...
import com.rise_of_the_six.RiseOfTheSix;
...
import com.rs.game.minigames.hungerGames.GameControler;
import com.rs.game.minigames.hungerGames.LobbyController;
...
import com.rs.game.player.content.citadels.CitadelControler;
import com.rs.game.player.content.citadels.Vistor;
...
import com.rs.game.player.controlers.soulwars.SoulLobbyControler;
import com.rs.game.player.controlers.soulwars.SoulWarsController;
...
public class ControlerHandler {
	...
	public static final void init() {
		try {
			...
			handledControlers.put("DungeonControler", (Class<Controler>) Class.forName(DungeonControler.class.getCanonicalName()));
			handledControlers.put("SoulLobbyControler", (Class<Controler>) Class.forName(SoulLobbyControler.class.getCanonicalName()));
			handledControlers.put("SoulWarsController", (Class<Controler>) Class.forName(SoulWarsController.class.getCanonicalName()));
			...
			handledControlers.put("RomeIntroduction", (Class<Controler>) Class.forName(RomeIntroduction.class.getCanonicalName()));
            handledControlers.put("Introduction", (Class<Controler>) Class.forName(Introduction.class.getCanonicalName()));
			handledControlers.put("HungerGames", (Class<Controler>) Class.forName(GameControler.class.getCanonicalName()));
			handledControlers.put("LobbyController", (Class<Controler>) Class.forName(LobbyController.class.getCanonicalName()));
			handledControlers.put("cages", (Class<Controler>) Class.forName(Cages.class.getCanonicalName()));
			handledControlers.put("citadel", (Class<Controler>) Class.forName(CitadelControler.class.getCanonicalName()));
			handledControlers.put("visitor", (Class<Controler>) Class.forName(Vistor.class.getCanonicalName()));
			handledControlers.put("RiseOfTheSix", (Class<Controler>) Class.forName(RiseOfTheSix.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
