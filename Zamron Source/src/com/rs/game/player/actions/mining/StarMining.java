...
public class StarMining extends MiningBase {
	...
	private boolean checkRock(Player player) {
		return World.getObjectWithId(new WorldTile(star.getX(), star.getY(), star.getPlane()), star.getId()) != null;
	}
	...
	public int processWithDelay(Player player) {
		...
		if(Utils.random(3) == 1) {
		   ...
		   int currentStarDust = player.getInventory().getNumerOf(13727) + (player.getBank().getItem(13727) == null ? 0 : player.getBank().getItem(13727).getAmount());
