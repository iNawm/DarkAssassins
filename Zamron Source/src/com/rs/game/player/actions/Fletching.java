...
public class Fletching extends Action {
	...
	public static enum Fletch {
		 ...
		 * Arrows
		 */
		HEADLESS_ARROWS(52, 314, new int[] { 53 }, new int[] { 15 },
				new double[] { 15 }, new Animation(6702)),

		BRONZE_ARROWS(39, 53, new int[] { 882 }, new int[] { 15 },
		...
		PEARL_BOLTS(46, 9140, new int[] { 880 }, new int[] { 41 },
				new double[] { 3.2 }, new Animation(6702)),
	...
	public static boolean maxMakeQuantityTen(Item item) {
        if (item.getId() == 52 || ItemDefinitions.getItemDefinitions(item.getId())
