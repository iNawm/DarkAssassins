...
public class WellOfFortune {
	...
	public static void handleBoost(Player player, int amount) {
		...
		player.sendMessage("<col=FF0000>You've received a "+Utils.getPercent(boost)+"% drop boost for "+Utils.getTimeLeft(player.getBoostTime())+"!");
		player.sendMessage("<col=FF0000>You've donated a total of "+Utils.formatNumber(player.getTotalDonatedToWell())+" gold to the Well of Good Fortune!");
	}
