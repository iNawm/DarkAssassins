...
public static int Author = 14;
	...
	public static void sendSupport(Player player) {
		player.getPackets().sendIComponentText(SUPPORT, Title, "ApolloRealm - Noticeboard Information");
		...
		player.getPackets().sendIComponentText(Author, NextPageTitle, "-Nexon, creator of ApolloRealm.");
