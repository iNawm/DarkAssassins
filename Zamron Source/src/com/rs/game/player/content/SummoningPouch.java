...
public enum SummoningPouch {
	 ...
	 */
	BARKER_TOAD_POUCH(12123, 66, 65, 6889, 1, 7, new Item(12158), new Item(
			12155), new Item(2150), new Item(12183, 11)),

	/**
	 * Represents a war tortoise pouch.
	 */
	WAR_TORTOISE_POUCH(12031, 66, 72, 6815, 0.7, 7, new Item(12158),
			new Item(12155), new Item(7939), new Item(12183, 1)),

	/**
	 * Represents a bunyip pouch.
	 */
	BUNYIP_POUCH(12029, 68, 67, 6813, 1.4, 7, new Item(12159), new Item(
			12155), new Item(383), new Item(12183, 110)),

	/**
	 * Represents a fruit bat pouch.
	 */
	FRUIT_BAT_POUCH(12033, 69, 68, 6817, 1.4, 8, new Item(12159), new Item(
			12155), new Item(1963), new Item(12183, 130)),

	/**
	 * Represents a ravenous locust pouch.
	 */
	RAVENOUS_LOCUST_POUCH(12820, 70, 69, 7372, 1.5, 4, new Item(12160),
			new Item(12155), new Item(1933), new Item(12183, 79)),

	/**
	 * Represents an arctic bear pouch.
	 */
	ARCTIC_BEAR_POUCH(12057, 71, 69, 6839, 1.1, 8, new Item(12158), new Item(
			12155), new Item(10117), new Item(12183, 14)),

	/**
	 * Represents a phoenix pouch.
	 */
	PHOENIX_POUCH(14623, 72, 70, 8575, 1.1, 8, new Item(12160), new Item(
			12155), new Item(14616), new Item(12183, 165)),

	/**
	 * Represents an obsidian golem pouch.
	 */
	OBSIDIAN_GOLEM_POUCH(12792, 73, 71, 7345, 7.3, 8, new Item(12163),
			new Item(12155), new Item(12168), new Item(12183, 195)),

	/**
	 * Represents a granite lobster pouch.
	 */
	GRANITE_LOBSTER_POUCH(12069, 74, 72, 6849, 3.7, 8, new Item(12160),
			new Item(12155), new Item(6983), new Item(12183, 166)),

	/**
	 * Represents a praying mantis pouch.
	 */
	PRAYING_MANTIS_POUCH(12011, 75, 73, 6798, 3.6, 8, new Item(12160),
			new Item(12155), new Item(2460), new Item(12183, 168)),

	/**
	 * Represents a forge regent pouch.
	 */
	FORGE_REGENT_BEAST(12782, 76, 74, 7335, 1.5, 9, new Item(12159),
			new Item(12155), new Item(10020), new Item(12183, 141)),

	/**
	 * Represents a talon beast pouch.
	 */
	TALON_BEAST_POUCH(12794, 77, 75, 7347, 3.8, 9, new Item(12160), new Item(
			12155), new Item(12162), new Item(12183, 174)),

	/**
	 * Represents a giant ent pouch.
	 */
	GIANT_ENT_POUCH(12013, 78, 76, 6800, 1.6, 8, new Item(12159), new Item(
			5933), new Item(12155), new Item(12183, 124)),

	/**
	 * Represents a hydra pouch.
	 */
	HYDRA_POUCH(12025, 80, 77, 9488, 1.6, 9, new Item(12159), new Item(571),
			new Item(12155), new Item(12183, 128)),

	/**
	 * Represents a spirit dagannoth pouch.
	 */
	SPIRIT_DAGANNOTH_POUCH(12017, 83, 78, 6804, 4.1, 9, new Item(12160),
			new Item(6155), new Item(12155), new Item(12183, 1)),

	/**
	 * Represents a unicorn stallion pouch.
	 */
	UNICORN_STALLION_POUCH(12039, 89, 79, 6822, 1.8, 9, new Item(12159),
			new Item(237),  new Item(12183, 203)),

	/**
	 * Represents a wolpertinger pouch.
	 */
	WOLPERTINGER_POUCH(12089, 92, 80, 6869, 4.5, 10, new Item(12160),
			new Item(2859), new Item(3226), new Item(12183, 203)),

	/**
	 * Represents a pack yak pouch.
	 */
	PACK_YAK_POUCH(12093, 96, 80, 6873, 4.8, 10, new Item(12160), new Item(
			10818), new Item(12183, 211)),

	/**
	 * Represents a fire titan pouch.
	 */
	FIRE_TITAN_POUCH(12802, 79, 81, 7355, 7.9, 9, new Item(12163), new Item(
			1442), new Item(12155), new Item(12183, 198)),

	/**
	 * Represents a moss titan pouch.
	 */
	MOSS_TITAN_POUCH(12804, 79, 82, 7357, 7.9, 9, new Item(12163), new Item(
			1440), new Item(12155), new Item(12183, 198)),

	/**
	 * Represents an ice titan pouch.
	 */
	ICE_TITAN_POUCH(12806, 79, 83, 7359, 7.9, 9, new Item(12163), new Item(
			1438), new Item(1444), new Item(12155), new Item(12183, 198)),

	/**
	 * Represents a lava titan pouch.
	 */
	LAVA_TITAN_POUCH(12788, 83, 84, 7341, 8.3, 9, new Item(12163), new Item(
			12168), new Item(12155), new Item(12183, 219)),

	/**
	 * Represents a swamp titan pouch.
	 */
	SWAMP_TITAN_POUCH(12776, 85, 85, 7329, 4.2, 9, new Item(12160), new Item(
			10149), new Item(12155), new Item(12183, 150)),

	/**
	 * Represents a geyser titan pouch.
	 */
	GEYSER_TITAN_POUCH(12786, 89, 86, 7339, 8.9, 9, new Item(12163),
			new Item(1444), new Item(12155), new Item(12183, 222)),

	/**
	 * Represents an abyssal titan pouch.
	 */
	ABYSSAL_TITAN_POUCH(12796, 93, 87, 7349, 1.9, 10, new Item(12159),
			new Item(12161), new Item(12155), new Item(12183, 113)),

	/**
	 * Represents an iron titan pouch.
	 */
	IRON_TITAN_POUCH(12822, 95, 88, 7375, 4.7, 10, new Item(12160), new Item(
			1115), new Item(12155), new Item(12183, 198)),

	/**
	 * Represents a steel titan pouch.
	 */
	STEEL_TITAN_POUCH(12790, 99, 89, 7343, 4.9, 10, new Item(12160),
