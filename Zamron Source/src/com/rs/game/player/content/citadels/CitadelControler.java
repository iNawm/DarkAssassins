...
import com.rs.game.player.actions.CitadelActions.CitadelCookFish;
import com.rs.game.player.actions.CitadelActions.CitadelGrabFish;
import com.rs.game.player.actions.CitadelActions.CitadelGrabOre;
import com.rs.game.player.actions.CitadelActions.CitadelMining;
import com.rs.game.player.actions.CitadelActions.CitadelSmeltOre;
import com.rs.game.player.actions.CitadelActions.CitadelSummoning;
import com.rs.game.player.actions.CitadelActions.CitadelWoodCutting;
import com.rs.game.player.actions.CitadelActions.CitadelMining.RockDefinitions;
import com.rs.game.player.actions.CitadelActions.CitadelSummoning.PouchDefinitions;
import com.rs.game.player.actions.CitadelActions.CitadelWoodCutting.RootDefinitions;
import com.rs.game.player.actions.Summ.Summoning.Pouches;
...
public class CitadelControler extends Controler {
	...
	public static WorldTile getWorldTile(int mapX, int mapY, Player player) {
		return new WorldTile((player.boundChunks[0] << 3) + mapX,
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.setNextWorldTile(getWorldTile(14, 12, player));
					player.setCanPvp(false);
