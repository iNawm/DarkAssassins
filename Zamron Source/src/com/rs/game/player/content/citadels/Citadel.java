...
public class Citadel {
	...
	public static void createBasicCitadel(Player player) {
		...
		player.setNextWorldTile(new WorldTile(getWorldTile(113, 10, player)));
		addSigns(player);
		addNpcs(player);
	}
	...
	public static void enterBattleField(Player player, Player owner) {
		player.setNextWorldTile(new WorldTile(getBWorldTile(31, 6, owner)));
		player.setCanPvp(true);
		player.inBattleField = true;

	}

	public static WorldTile getBWorldTile(int mapX, int mapY, Player player) {
		return new WorldTile((player.boundChunks2[0] << 3) + mapX,
