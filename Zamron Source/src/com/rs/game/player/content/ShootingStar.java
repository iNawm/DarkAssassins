...
public class ShootingStar {
	...
	public static void spawnRandomStar() {
		...
		if (tiles[Utils.random(0, 3)] == tile) {
			...
			crashedStar = 2;
			World.sendWorldMessage("<img=6><col=ff0000>News: A Shooting Star has just struck Rimmington Mines!", false);
			World.spawnObject(new WorldObject(38660, 10, 0 , 2974, 3238, 0), true);
		} else if (tiles[Utils.random(0, 3)] == tile3) {
			//Varrock Spawn
			crashedStar = 3;
			World.sendWorldMessage("<img=6><col=ff0000>News: A Shooting Star has just struck Varrock lodestone area!", false);
