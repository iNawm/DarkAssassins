...
public class Slayer {
	...
	// finished
	BIRD(1, new String[] { "Birds are a type of species found throughout Zamron in different forms.", "It's recommended that you bring range weapons to fight these monsters.", "Avansies are the strongest and most widely known type of bird.", "Chickens are great for a fast task." }, AVIANSIE, CHICKEN, CHOMPY_BIRD, DUCK),
