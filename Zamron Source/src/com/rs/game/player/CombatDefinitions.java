...
public final class CombatDefinitions implements Serializable {
	...
	public String getPrefix(int slotId) {
			String n = String.valueOf(getBonuses()[slotId]);
			if (n.startsWith("-") || n.contentEquals("0")) {//remove n.contentEquals("0") if you want zeros with + signs
				prefix = "";
			} else
				prefix = "+";
		return prefix;
