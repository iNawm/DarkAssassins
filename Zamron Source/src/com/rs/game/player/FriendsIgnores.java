...
public class FriendsIgnores implements Serializable {
	...
	p2.getPackets().receivePrivateMessage(Utils.formatPlayerNameForDisplay(player.getUsername()), player.getDisplayName(), player.getIconMessage(), message);
    }
	...
	public void sendQuickChatMessage(Player p2,
		...
		p2.getPackets().receivePrivateChatQuickMessage(
				...
				player.getDisplayName(), player.getIconMessage(), quickChatMessage);
