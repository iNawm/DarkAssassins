...
import com.rs.game.minigames.puropuro.PuroPuro;
...
public class ButtonHandler {
	...
	//player.getpackets().Sendicomponenttext(506, 0, "Zamron panel");
	...
	if (packetId == WorldPacketsDecoder.ACTION_BUTTON1_PACKET)
		...
		if (interfaceId == 548 || interfaceId == 746) {
			if ((interfaceId == 548 && componentId == 148)
				...
				player.setNextAnimation(new Animation(840)); // Reading worldmap
			...
			player.getDialogueManager().startDialogue("Transportation",
					"Bandos", new WorldTile(2916, 3746, 0),
					"Armadyl", new WorldTile(2916, 3746, 0),
					"Saradomin", new WorldTile(2916, 3746, 0),
					"Zamorak", new WorldTile(2916, 3746, 0));
				break;
			case 70: //rfd
		 		player.closeInterfaces();
		player.getControlerManager().startControler("RecipeforDisaster", 1); 
			...
			case 71: //Livid Farms
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2111, 3940, 0));
            player.getPackets().sendGameMessage("Take a Orb, Click on the patches for plants, Bunch 27 and deposit them for XP.");
				break;
			case 53: //Corp
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2966, 4383, 2));
				player.getControlerManager().startControler("CorpBeastControler");
            player.getPackets().sendGameMessage("This is a DANGEROUS Minigame, You will lose ALL your items upon death...");
		 		player.closeInterfaces();
				break;
			case 54: //Merc Mage
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(214, 5515, 0));
				player.getControlerManager().startControler("CorpBeastControler");
            player.getPackets().sendGameMessage("This is a DANGEROUS Minigame, You will lose ALL your items upon death...");
				break;
			case 55: //Lucien
			...
			case 56: //Blink
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(198, 5511, 0));
				player.getControlerManager().startControler("CorpBeastControler");
            player.getPackets().sendGameMessage("This is a DANGEROUS Minigame, You will lose ALL your items upon death...");
				break;
			case 60: //dag prime
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2517, 4646, 0));
				break;
			case 57: //yklag
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(246, 5509, 0));
				player.getControlerManager().startControler("CorpBeastControler");
            player.getPackets().sendGameMessage("This is a DANGEROUS Minigame, You will lose ALL your items upon death...");
				break;
			case 58: //nex
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2905, 5203, 0));
				break;
			case 59: //qbd
		 		player.closeInterfaces();
			...
			player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(4183, 5729, 0));
				break;
			case 43: //Start Skilling Tab Fishing
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2616, 3845, 0));
				break;
			case 44: // Mining
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3300,
						3312, 0));
				break;
			case 45: // Hunter
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2526,
						2916, 0));
player.getControlerManager().startControler("Falconry");
				break;
			case 46: // Woodcutting
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3161,
						3223, 0));
				break;
			case 47: // RuneCrafting

		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2598, 3163, 0));
				
				break;
			case 48: // Summoning
	
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2209,
						5343, 0));
			...
			case 49: // Agility
		 		...
		 		player.closeInterfaces();
			player.getDialogueManager().startDialogue("Transportation",
					"Gnome Agility Course", new WorldTile(2470, 3436, 0),
					"Barbarian Agility Course", new WorldTile(2552, 3563, 0),
					"Wilderness Agility Course", new WorldTile(2998, 3932, 0),
					"Home", new WorldTile(2847, 5071, 0));
				
				break;
			case 50: // Cooking

		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3033, 4957, 0));
				
				break;
			case 51: // Thieving

		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2660, 3306, 0));
				
				break;
			case 37: //start minigames PC
			
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2656, 2593, 0));
					player.getPackets().sendGameMessage("Go near the portals and kill the monsters for tickets. Exchange them for void armours!.");
				
				break;
			case 38: //ClanW
			
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2994, 9679, 0));
				
				break;
			case 39: //CastleW
				
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(CastleWars.LOBBY));
				
				break;
			case 40: //Barrows
			
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3565, 3289, 0));
				
				break;
			case 41: //Fight Caves
			
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(4610, 5130, 0));
				
				break;
			case 42: //zombies
			
		 		player.closeInterfaces();
				Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(4744, 5172, 0));
				
				break;
			case 64: //Start Misc Teles TrollZone
				
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2441, 3159, 0));
			...
			case 65: //Chill
		 		...
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(2315, 4559, 0));
				
				break;
			case 66: //Revs
			
		 		player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3077, 10058, 0));
			...
			case 69: //polypore
		 	...
		 	player.closeInterfaces();
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(4652, 5404, 0));
		...
		Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2998, 3119, 0));
			...
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3823, 4767, 0));
		} else if (componentId == 139) {
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(215, 5384, 0));
		} else if (componentId == 112) {
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(234, 5515, 0));
		} else if (componentId == 118) {
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3107, 5537, 0));
		} else if (componentId == 136) {
			Magic.sendCustomTeleportSpell(player, 0, 0, new WorldTile(3233, 2789, 0));
		} else if (componentId == 124) {
			Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2151, 5536, 3));
...
player.getPackets().sendGameMessage("You bought one!");		
		...
		//Dark Invasion
            ...
            if(componentId == 16)
            	player.getPackets().sendOpenURL("http://Zamron.org/");
            if (componentId == 18) {
		...
		if (interfaceId == 95) { //Sailing
			...
			if (componentId == 2){
                ...
                player.getPackets().sendIComponentText(275, 13, "<img=11><col=FF00>Regular Donator Features<img=11>");
                player.getPackets().sendIComponentText(275, 14, "Access to the extremely awesome Donator Zone.");
                player.getPackets().sendIComponentText(275, 15, "Ability to set a custom title. ::title 1-60");
                player.getPackets().sendIComponentText(275, 16, "Ability to change the color of your skin. ::blueskin ::greenskin");
                player.getPackets().sendIComponentText(275, 17, "Ability to bank anywhere EXCEPT in minigames. ::bank");
                player.getPackets().sendIComponentText(275, 18, "Increased EXP Rates from 1 to 1.2.");
                player.getPackets().sendIComponentText(275, 19, "An epic rank and yell title, and a red donator icon.");
                player.getPackets().sendIComponentText(275, 20, "Access to beta features before they are released!");
                player.getPackets().sendIComponentText(275, 21, "Be able to Summon Pak-Yak and Bunyip.");
                player.getPackets().sendIComponentText(275, 22, "Access to a custom minigame Refuge of Fear.");
                player.getPackets().sendIComponentText(275, 23, "Increased Loyalty Points per 30 minutes of play.");
                player.getPackets().sendIComponentText(275, 24, "Access to about 8+ extra shops.");
                player.getPackets().sendIComponentText(275, 25, "Ability to yell. ::yell");
                player.getPackets().sendIComponentText(275, 26, "");
				player.getPackets().sendIComponentText(275, 27, "");
                player.getPackets().sendIComponentText(275, 28, "<img=8><col=006600><shad=000000>Extreme Donator Features<img=8>");
				player.getPackets().sendIComponentText(275, 29, "");
                player.getPackets().sendIComponentText(275, 30, "Get all the features of a Regular Donator.");
                player.getPackets().sendIComponentText(275, 31, "Increased EXP Rates from 1 to 1.4");
                player.getPackets().sendIComponentText(275, 32, "Ability to use 5 new pets.");
                player.getPackets().sendIComponentText(275, 33, "Ability to use wing auras and special tier auras.");
                player.getPackets().sendIComponentText(275, 34, "Slightly increased drop rates.");
				player.getPackets().sendIComponentText(275, 35, "Custom title color + shade");
				player.getPackets().sendIComponentText(275, 36, "Different skilling animatons");
				player.getPackets().sendIComponentText(275, 37, "Custom teleport animatons");
                player.getPackets().sendIComponentText(275, 38, "A Green donator symbol.");
                player.getPackets().sendIComponentText(275, 39, "");
				player.getPackets().sendIComponentText(275, 40, "");
                player.getPackets().sendIComponentText(275, 41, "<img=12><col=0000FF><shad=000000>Elite Features<img=12>");
				player.getPackets().sendIComponentText(275, 42, "");
                player.getPackets().sendIComponentText(275, 43, "Get all the features of a Regular Donator and Extreme.");
                player.getPackets().sendIComponentText(275, 44, "Ultimate priority over other players.");
                player.getPackets().sendIComponentText(275, 45, "Better chances at the Squeal of Fortune");
                player.getPackets().sendIComponentText(275, 46, "To be able to have the ultimate pet, TzRek Jad");
                player.getPackets().sendIComponentText(275, 47, "Increased EXP Rates from 1 to 1.75");
                player.getPackets().sendIComponentText(275, 48, "Mithril Seeds, to play Hot/Cold");
                player.getPackets().sendIComponentText(275, 49, "Drop rates increase giving you a better chance for rare items!");
                player.getPackets().sendIComponentText(275, 50, "::Setdisplay/::RemoveDisplay - Changes your in-game name");
                player.getPackets().sendIComponentText(275, 51, "A Blue donator symbol.");
                player.getPackets().sendIComponentText(275, 52, "Custom title ::titlestring");
                player.getPackets().sendIComponentText(275, 54, "");
				player.getPackets().sendIComponentText(275, 55, "");
                player.getPackets().sendIComponentText(275, 56, "<img=13><col=ffa34c><shad=000000>Supreme Donator Features<img=13>");
				player.getPackets().sendIComponentText(275, 57, "");
                player.getPackets().sendIComponentText(275, 58, "Get all the features of a Regular, Extreme Donator, and Elite.");
                player.getPackets().sendIComponentText(275, 59, "Increased EXP Rates from 1 to 2.");
                player.getPackets().sendIComponentText(275, 60, "Access to the Supreme Donator Shop");
                player.getPackets().sendIComponentText(275, 61, "Ability to purchase and use the Golden and Royal Cannons");
                player.getPackets().sendIComponentText(275, 62, "The good feeling of helping us pay for our server costs ($50+ per month)");
                player.getPackets().sendIComponentText(275, 63, "A bonus of 500 Donator Tokens");
                player.getPackets().sendIComponentText(275, 64, "Access to an exclusive training area");
                player.getPackets().sendIComponentText(275, 65, "Ability to have a custom yell tag coded for you");
                player.getPackets().sendIComponentText(275, 66, "A Gold donator symbol.");
                player.getPackets().sendIComponentText(275, 67, "Access to the Supreme Donator Shop");
                player.getPackets().sendIComponentText(275, 68, "Ability to have a custom yell tag/title coded for you");
                player.getPackets().sendIComponentText(275, 69, "A custom pet, coded just for you (or for others if you like)");
				player.getPackets().sendIComponentText(275, 70, "Unlimited supply of Supreme Corruption for wings");       
				player.getPackets().sendIComponentText(275, 71, "Unlimited supply of Supreme Salvation for wings");
                player.getPackets().sendIComponentText(275, 72, "Access to new items such as Godcrusher and Tokhaar Warlord");
                player.getPackets().sendIComponentText(275, 73, "");
				player.getPackets().sendIComponentText(275, 74, "");
                player.getPackets().sendIComponentText(275, 75, "<img=11><col=0000FF><shad=000000>Donation Options<img=11>");
				player.getPackets().sendIComponentText(275, 76, "");
                player.getPackets().sendIComponentText(275, 77, "<col=FF0000>Regular Donator<col=000000>-<col=FFA500>10$");
                player.getPackets().sendIComponentText(275, 78, "<col=006600>Extreme Donator<col=000000>-<col=FFA500>15$");
                player.getPackets().sendIComponentText(275, 79, "<col=0000FF>Elite<col=000000>-<col=FFA500>25$");
                player.getPackets().sendIComponentText(275, 80, "<col=ffa34c>Supreme Donator<col=000000>-<col=FFA500>50$");
                ...
                player.getPackets().sendIComponentText(275, 85, "Spins are priced at 0.25$");
                player.getPackets().sendIComponentText(275, 86, "For every 10 spins you buy, you get 2 free!");
                player.getPackets().sendIComponentText(275, 87, "<img=12><col=0000FF><shad=000000>Donator Tokens<img=12>");
                player.getPackets().sendIComponentText(275, 88, "You receive 100 donator tokens per 1$ you donate.");
    ...
    player.getPackets().sendIComponentText(583, 79, "<col=e5ff00>Page 2. ");
				...
				//player.getDialogueManager().startDialogue("MTLowLevelTraining", true);
				//player.getDialogueManager().startDialogue("TeleportCrystal", true);
		...
		Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2393, 3857, 0));	
    ...
    player.getPackets().sendIComponentText(583, 79, "<col=e5ff00>Page 2. ");
		...
		Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(4651, 5389, 0));
		}else if (componentId == 61){
    ...
    player.getPackets().sendIComponentText(583, 79, "<col=e5ff00>Page 2. ");
		...
		if (interfaceId == 1264) {
		    ...
		    player.closeInterfaces();
		} else if (interfaceId == 31) {
			AdminNPCInterface.handleButtons(player, componentId);
...
player.getPackets().sendGameMessage("You bought one!");		
			...
			case 93:
				if (player.getDungTokens() >= 150000) {
					...
					player.getPackets()
							.sendGameMessage("Purchase successful.");
				} else {
					player.getPackets().sendGameMessage(
							"You need 150,000 tokens to buy this!");
				}
				break;
			case 97:
				if (player.getDungTokens() >= 150000) {
			...
			case 125:
				if (player.getDungTokens() >= 25000) {
					...
					player.getPackets().sendGameMessage(
							"You need 25,000 tokens to buy this!");
				}
				break;
			case 129:
				if (player.getDungTokens() >= 50000) {
		...
		if (interfaceId == 540 ) {
			...
			if (componentId == 44)
			player.setNextAnimation(new Animation(-1)); // Stops reading worldmap
				player.getPackets().sendWindowsPane(
						player.getInterfaceManager().hasRezizableScreen() ? 746
								: 548, 2);
			 if (componentId == 42) {
	...
	for (Item item : items[1])
	    carriedWealth = riskedWealth += ItemManager.getPrice(item.getId()) * item.getAmount();
	for (Item item : items[0])
	    carriedWealth += ItemManager.getPrice(item.getId()) * item.getAmount();
	if (slots[0].length > 0) {
	...
	public static void refreshEquipBonuses(Player player) {
		...
		player.getPackets().sendIComponentText(667, 38,
				"Summoning: "+player.getCombatDefinitions().getPrefix(10)+ player.getCombatDefinitions().getBonuses()[10]);
		player.getPackets().sendIComponentText(667, 39, 
				"Absorb Melee: "+player.getCombatDefinitions().getPrefix(11)+ player.getCombatDefinitions().getBonuses()[11] + "%");
		player.getPackets().sendIComponentText(667, 40,
				"Absorb Magic: "+player.getCombatDefinitions().getPrefix(12)+ player.getCombatDefinitions().getBonuses()[12] + "%");
		player.getPackets().sendIComponentText(667, 41,
				"Absorb Ranged: "+player.getCombatDefinitions().getPrefix(13)+ player.getCombatDefinitions().getBonuses()[13]+ "%");
		...
		player.getPackets().sendIComponentText(667, 43,
				"Ranged Str: "+player.getCombatDefinitions().getPrefix(15)+ player.getCombatDefinitions().getBonuses()[15]);
		player.getPackets().sendIComponentText(667, 44,
				"Prayer: "+player.getCombatDefinitions().getPrefix(16)+ player.getCombatDefinitions().getBonuses()[16]);
		player.getPackets().sendIComponentText(667, 45,
				"Magic Damage: "+player.getCombatDefinitions().getPrefix(17) + player.getCombatDefinitions().getBonuses()[17] + "%");
			WeightManager.calculateWeight(player);
	}
