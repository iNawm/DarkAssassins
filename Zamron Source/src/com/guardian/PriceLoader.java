...
public class PriceLoader {
	...
	public void initialize() {
		...
		append("[Guardian] Done loading Price Guide. (Execution Time: "+((double)(end - start) / 1000)+" seconds)");
		append("[Guardian] Type a search term in the field above. Results are shown here.");
	}
